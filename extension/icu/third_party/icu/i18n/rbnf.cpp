...
static const UChar rbnf_DQUOTE_STOPLIST[] = {
    rbnf_QUOTE, 0
};

static const UChar rbnf_SQUOTE_STOPLIST[] = {
    rbnf_TICK, 0
};

static const UChar rbnf_NOQUOTE_STOPLIST[] = {
...
LocDataParser::nextString() {
    ...
    if (p < e) {
        ...
        if (haveQuote) {
            inc();
            terminators = c == rbnf_QUOTE ? rbnf_DQUOTE_STOPLIST : rbnf_SQUOTE_STOPLIST;
        } else {
            terminators = rbnf_NOQUOTE_STOPLIST;
        }
        UChar* start = p;
