...
const UChar *CompactData::getPattern(
    ...
    if (dq.hasIntegerValue()) {
        ...
        if (i == 0) {
            patternString = patterns[number_compact_getIndex(magnitude, StandardPlural::Form::EQ_0)];
        } else if (i == 1) {
            patternString = patterns[number_compact_getIndex(magnitude, StandardPlural::Form::EQ_1)];
        }
    ...
    patternString = patterns[number_compact_getIndex(magnitude, plural)];
