 ...
 */
constexpr int8_t uvec_HINT_KEY_POINTER = 1;
constexpr int8_t uvec_HINT_KEY_INTEGER = 0;
...
int32_t UVector::indexOf(void* obj, int32_t startIndex) const {
    UElement key;
    key.pointer = obj;
    return indexOf(key, startIndex, uvec_HINT_KEY_POINTER);
}

int32_t UVector::indexOf(int32_t obj, int32_t startIndex) const {
    UElement key;
    key.integer = obj;
    return indexOf(key, startIndex, uvec_HINT_KEY_INTEGER);
}
